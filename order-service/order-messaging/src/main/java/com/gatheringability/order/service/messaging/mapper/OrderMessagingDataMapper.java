package com.gatheringability.order.service.messaging.mapper;

import com.gatheringability.kafka.order.avro.model.*;
...
public class OrderMessagingDataMapper {
    ...
    public RestaurantApprovalRequestAvroModel orderPaidEventToRestaurantRequestAvroModel(OrderPaidEvent orderPaidEvent) {
        ...
        return RestaurantApprovalRequestAvroModel.newBuilder()
                ...
                .setRestaurantOrderStatus(com.gatheringability.kafka.order.avro.model.RestaurantOrderStatus
                        .valueOf(order.getOrderStatus().name()))
                .setProducts(order.getItems().stream().map(orderItem ->
                        com.gatheringability.kafka.order.avro.model.Product.newBuilder()
    ...
    public PaymentResponse paymentResponseAvroModelToPaymentResponse(PaymentResponseAvroModel paymentResponseAvroModel) {
        return PaymentResponse.builder()
                ...
                .paymentStatus(com.gatheringability.domain.valueobject.PaymentStatus.valueOf(
    ...
    public RestaurantApprovalResponse approvalResponseAvroModelToApprovalResponse(RestaurantApprovalResponseAvroModel restaurantApprovalResponseAvroModel) {
        return RestaurantApprovalResponse.builder()
                ...
                .orderApprovalStatus(com.gatheringability.domain.valueobject.OrderApprovalStatus.valueOf(
