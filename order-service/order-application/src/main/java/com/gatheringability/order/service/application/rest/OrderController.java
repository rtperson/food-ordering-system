package com.gatheringability.order.service.application.rest;
...
@Slf4j
@RestController
@RequestMapping(value = "/orders", produces = "application/vn..api.v1+json")
public class OrderController {
    ...
    public ResponseEntity<TrackOrderResponse> getOrderTracking(@PathVariable UUID trackingId) {
