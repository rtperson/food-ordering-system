...
import com.gatheringability.domain.valueobject.PaymentStatus;
...
import com.gatheringability.payment.service.domain.valueobject.TransactionType;
...
public class PaymentDomainServiceImpl implements PaymentDomainService {
    ...
    public PaymentEvent validateAndInitiatePayment(Payment payment,
                                                   ...
                                                   DomainEventPublisher<PaymentCompletedEvent> paymentCompletedEventPublisher, DomainEventPublisher<PaymentFailedEvent> paymentFailedEventDomainEventPublisher) {
    ...
    public void validateCreditEntry(Payment payment,
                                            CreditEntry creditEntry,
                                            List<String> failureMessages) {
